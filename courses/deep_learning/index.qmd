...
[Slides](Deep_Learning_04_RNN.html){target="_blank"} </br>
[Ejemplo 1: RNN y LSTM: pronóstico de series temporales en R](Deep_Learning_04_examples_01.html){target="_blank"} </br>
[Ejemplo 2: LSTM y GRU: análisis de sentimiento con IMDB en R](Deep_Learning_04_examples_02.html){target="_blank"} </br>
[Ejemplo 3: LSTM: generación de texto carácter a carácter en R](Deep_Learning_04_examples_02b.html){target="_blank"}
:::
...
[Slides](Deep_Learning_05_Generative.html){target="_blank"}
:::
